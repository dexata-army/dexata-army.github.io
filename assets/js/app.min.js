...
var handleThemePanel = function() {
	...
	$(document).on('click', '['+ app.themePanel.toggleAttr +']', function() {
		...
		if (Cookies) {
			...
			localStorage.setItem(app.themePanel.cookieName, targetExpand);
		}
	});
	...
	if (Cookies) {
		...
		var themePanelExpand = localStorage.getItem(app.themePanel.cookieName);
	...
	$(document).on('click', '.'+ app.themePanel.class +' ['+ app.themePanel.theme.toggleAttr +']', function() {
		...
		if (Cookies) {
			...
			localStorage.setItem(app.themePanel.theme.cookieName, targetTheme);
	...
	if (Cookies) {
		...
		if (localStorage.getItem(app.themePanel.theme.cookieName)) {
			$('.'+ app.themePanel.class +' ['+ app.themePanel.theme.toggleAttr +']' + '['+ app.themePanel.theme.classAttr +'="'+ localStorage.getItem(app.themePanel.theme.cookieName) +'"]').trigger('click');
	...
	$(document).on('click', '.'+ app.themePanel.class +' ['+ app.themePanel.themeCover.toggleAttr +']', function(e) {
		...
		if (Cookies) {
			...
			localStorage.setItem(app.themePanel.themeCover.cookieName, targetTheme);
		}
	});
	
	if (Cookies) {
		//if (Cookies.get(app.themePanel.themeCover.cookieName)) {
		if (localStorage.getItem(app.themePanel.themeCover.cookieName)) {
			$('.'+ app.themePanel.class +' ['+ app.themePanel.themeCover.toggleAttr +']' + '['+ app.themePanel.themeCover.classAttr +'="'+ localStorage.getItem(app.themePanel.themeCover.cookieName) +'"]').trigger('click');
		}
	}
};
